...
var $ = require('jquery');
var taskElement = '<li class="task">' + '<input class="complete" type="checkbox"/>' + '<input type="text" class="description"/>' + '<input type="button" value="Delete" class="delete-task"/>' + '</li>';
...
},{"./taskData":3,"./taskRender":4,"jquery":1}]},{},[2]);
